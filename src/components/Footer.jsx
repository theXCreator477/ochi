...
function Footer() {
  return (
    <div className='px-8 pt-12 flex'>
      <div className='w-1/2 flex flex-col justify-between'>

        <div>
          <h1 className='semibold uppercase text-[10vw] leading-[8vw]'>eye-</h1>
          <h1 className='semibold uppercase text-[10vw] leading-[8vw]'>opening</h1>
        </div>
      ...
      <div className='w-1/2 regular'>
        <h1 className='semibold uppercase text-[10vw] leading-[8vw]'>presentations</h1>

        <FooterLinks heading={'S:'} links={['instagram', 'behance', 'facebook', 'linkedin']} />

        <div className="flex justify-between">
          <FooterLinks heading={'L:'} links={['202-1965 w 4th ave', ' vancouver, canada', '30 chukarina st', 'lviv, ukraine']} />

          <FooterLinks heading={'M:'} links={['home', 'services', 'our work', 'about us', 'insights', 'contact us']} />
        </div>

        <FooterLinks heading={'E:'} links={['hello@ochi.design']} />

        <div className='flex justify-between text-sm text-zinc-600 py-8'>
          <p className=''>&#169; ochi design 2024. Legal Terms</p>
          <p className=''>Website by Obys</p>
        </div>
